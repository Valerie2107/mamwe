...
class ManagerLivreDor implements ManagerInterface
{
    ...
    public function insertPatient(MappingLivreDor $data){
        ...
        $sql = "INSERT INTO `mw_livredor`(`mw_name_livredor`, `mw_mail_livredor`, `mw_message_livredor`, `mw_date_livredor`, `mw_visibility_livredor`) 
        VALUES (:name, :mail, :message, :date, :visibility)";  
        ...
        $prepare->bindValue(':phone', $data->getMwVisibilityLivreDor(), PDO::PARAM_INT);
    ...
    public function updateMessage(MappingLivreDor $data){
        $sql = "UPDATE `mw_livredor` 
                SET `mw_name_livredor`= :name, `mw_mail_livredor`= :mail, `mw_message_livredor`= :message, `mw_date_livredor`= :date,`mw_visibility_livredor`= :visibility 
        ...
        $prepare->bindValue(':visibility', $data -> getMwVisibilityLivreDor(), PDO::PARAM_STR);
