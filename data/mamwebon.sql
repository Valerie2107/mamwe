...
CREATE TABLE IF NOT EXISTS `mamwetest`.`mw_homepage` (
  ...
  `mw_section_idmw_section` INT UNSIGNED NOT NULL,
  `mw_section_mw_article_idmw_article` INT UNSIGNED NOT NULL,
  `mw_section_mw_ressources_mw_ID_ressources` INT NOT NULL,
  PRIMARY KEY (`idmw_home`, `mw_section_idmw_section`, `mw_section_mw_article_idmw_article`, `mw_section_mw_ressources_mw_ID_ressources`),
  INDEX `fk_mw_homepage_mw_section1_idx` (`mw_section_idmw_section` ASC, `mw_section_mw_article_idmw_article` ASC, `mw_section_mw_ressources_mw_ID_ressources` ASC) VISIBLE,
  CONSTRAINT `fk_mw_homepage_mw_section1`
    FOREIGN KEY (`mw_section_idmw_section` , `mw_section_mw_article_idmw_article` , `mw_section_mw_ressources_mw_ID_ressources`)
    REFERENCES `mamwetest`.`mw_section` (`idmw_section` , `mw_article_idmw_article` , `mw_ressources_mw_ID_ressources`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
