...
<!-- affichage des articles dans un tableau : -->
                ...
                <td>
                    <ul>
                        <?php foreach($pictures as $picture): ?>
                            <li class="crud-pic-list">
                            <?= $picture -> getMwTitlePicture() ; ?>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </td>
                <td class="crud-section"><?= $article->getMwSectionMwIdSection()?></td>
    ...
    <form class="crud-form" action="" method="POST" id="insert-article">
        ...
        <label for="mw_visible_art">Visibilité :</label>
        ...
        <select name="mw_section_mw_id_section">
            <?php foreach($allSection as $section) : ?>
                <option value="<?= $section -> getMwIdSect() ?>" id="mw_section_mw_id_section" name="mw_section_mw_id_section"><?= $section -> getMwTitleSect() ?></option><br>
            <?php endforeach; ?>
        </select>
        ...
        <button type="button" id="addPicture">Add Picture</button><br>
